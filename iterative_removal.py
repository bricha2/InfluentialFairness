    ...
    for metric in metrics:
        ...
        for step_size in step_sizes:
            ...
            for name, title, inf_df in zip(['GT', 'BB_public', 'GB'],
                ...
                fn = "%s/out/nonstatic_removal_%s_%s_%s_%s_iterations.csv"%(data_name, data_name, metric, 
                                                                                    name,str(step_size))
                ...
                while (n_points < original_size*2):
                    ...
                    if name == 'GT' or 'train' in name:
                        ...
                        points_matched = not_df_train[not_df_train.apply(tuple,1).isin(topn_samples.apply(tuple,1))].shape[0]
                ...
                disp_tb.to_csv("%s/out/nonstatic_removal_%s_%s_%s_%s_iterations.csv"%(data_name, data_name, metric, 
                                                                                    name,str(step_size)))
