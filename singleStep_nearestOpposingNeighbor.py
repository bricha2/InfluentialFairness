...
if __name__ == "__main__":
    ...
    for metric in metrics:
        ...
        for label, title, temp_df in zip(['GT', 'BB_public', 'GB'],
            ...
            fn = "%s/out/static_nearestOppNeigh_%s_%s_%s_iterations.csv"%(data_name, data_name, metric, label)
            ...
            disp_tb.to_csv("%s/out/static_nearestOppNeigh_%s_%s_%s_iterations.csv"%(data_name, data_name, metric, label))
